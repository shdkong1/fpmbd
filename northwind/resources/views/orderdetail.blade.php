    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Order Detail</li>
            </ol>
          </div>
        </div><!-- /.row -->
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                    @foreach($order_details as $dataorderdetail)
                        <tr>
                            <td><?= $dataorderdetail->order_id ?></td>
                            <td><?= $dataorderdetail->product_id ?></td>
                            <td><?= $dataorderdetail->unit_price ?></td>
                            <td><?= $dataorderdetail->quantity ?></td>
                            <td><?= $dataorderdetail->discount ?></td>
                            <td class="text-center">
                                <a href="{{ route('edit', $dataorderdetail->order_id ) }}" class="btn btn-primary btn-sm">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tambahBarangLabel">New Order Detail</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('orderdetail/add_orderdetail') }}" method="POST" enctype="multipart/form-data">
            @csrf
