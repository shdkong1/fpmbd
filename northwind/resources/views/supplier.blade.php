    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Supplier</li>
            </ol>
          </div>
        </div><!-- /.row -->
                ...
                <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                        <tr>
                            ...
                            <th>Homepage<i class="fa fa-sort"></i></th>
                    ...
                    @foreach($suppliers as $datasupplier)
                        <tr>
                            <td><?= $datasupplier->supplier_id ?></td>
                            <td><?= $datasupplier->company_name ?></td>
                            <td><?= $datasupplier->contact_name ?></td>
                            <td><?= $datasupplier->contact_title ?></td>
                            <td><?= $datasupplier->address ?></td>
                            <td><?= $datasupplier->city ?></td>
                            <td><?= $datasupplier->region ?></td>
                            <td><?= $datasupplier->postal_code ?></td>
                            <td><?= $datasupplier->country ?></td>
                            <td><?= $datasupplier->phone ?></td>
                            <td><?= $datasupplier->fax ?></td>
                            <td><?= $datasupplier->homepage ?></td>
                            <td class="text-center">
                                <a href="{{ route('edit', $datasupplier->supplier_id ) }}" class="btn btn-primary btn-sm">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tambahBarangLabel">New Supplier</h5>
